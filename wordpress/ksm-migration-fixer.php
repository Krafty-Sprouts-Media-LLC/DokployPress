...
class KSM_Migration_Fixer {
	 ...
	 * Full URL replacement in post content and plugin data is left to WP-CLI or a plugin.
	 *
	 * @since 1.1.0
	 * @param array $log Log lines (by reference).
	 * @return void
	...
	private static function fix_site_urls( array &$log ) {
		...
		$log[] = '  — For URLs in content/widgets/plugins run: wp search-replace (see docs/hosting-guide.md).';
	}
